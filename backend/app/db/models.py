...
class PgListing(Base):
    ...
    pg_name: Mapped[str | None] = mapped_column(String(120), nullable=True)
    ...
    monthly_rent: Mapped[int | None] = mapped_column(Integer, nullable=True)
    occupancy_type: Mapped[str | None] = mapped_column(String(40), nullable=True)
    ...
    listing_status: Mapped[str] = mapped_column(String(20), nullable=False, default="active", index=True)
    availability_status: Mapped[str] = mapped_column(String, nullable=False, index=True)
    availability_note: Mapped[str | None] = mapped_column(String(200), nullable=True)
